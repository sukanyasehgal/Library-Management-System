...
import pojoFiles.BookIssuedBean;
import configuration.ConnectionManager;

public class SessionRegistrationsDAO {

	public List<BookIssuedBean> displaySessionRegistrations() {

		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection connection = null;

		List<BookIssuedBean> listOfSessionRegistrations = new ArrayList<>();
		...
		try {
			...
			while (result.next()) {
				BookIssuedBean sessionRegistrationsBean = new BookIssuedBean();
